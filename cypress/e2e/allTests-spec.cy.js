describe("Items page", () => {
  ...
  it("Should be able to create an item", () => {
    ...
    cy.get(":nth-child(6) > .list-label > ul").contains("Medicine");
  });
  it("Should be able to delete an item", () => {
    ...
    cy.get(":nth-child(6) > .list-label > .delete-item-button").click();
    cy.get(":nth-child(6) > .list-label > ul").should("not.exist");
  });
});
